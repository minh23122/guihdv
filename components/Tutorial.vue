    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="flex justify-center pt-4 space-x-2">
        <div class="card" style="width: 20%; margin: 20px;">
            <img class="card-img-top" src="assets/img/product1.jfif" alt="Laptop Acer Gaming Nitro 5">
            <div class="card-body">
              <h5 class="card-title">Laptop Acer Gaming Nitro 5</h5>
              <p class="card-text">i5 11400H/8GBRam/512GB SSD/GTX1650 4G/15.6 inch FHD 144Hz/Win 11/Đen <br> Còn lại: 10 <br> Giá: 12.000.000 đ</p>
              <a href="#" class="btn btn-primary">Buy</a>
            </div>
          </div>
          <div class="card" style="width: 20%; margin: 20px;">
            <img class="card-img-top" src="assets/img/product1.jfif" alt="Laptop Asus VivoBook">
            <div class="card-body">
              <h5 class="card-title">Laptop Asus VivoBook</h5>
              <p class="card-text">i5 11400H/8GBRam/512GB SSD/GTX1650 4G/15.6 inch FHD 144Hz/Win 11/Đen <br> Còn lại: 0 <br> Giá: 22.000.000 đ</p>
              <a href="#" class="btn btn-primary">Buy</a>
            </div>
          </div>
      </div>
